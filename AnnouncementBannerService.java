...
public class AnnouncementBannerService {
    private static final Logger log = LoggerFactory.getLogger(AnnouncementBannerService.class);
    ...
    @Inject
    public AnnouncementBannerService(@ComponentImport PluginSettingsFactory pluginSettingsFactory) {
